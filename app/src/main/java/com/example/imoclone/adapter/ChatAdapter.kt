...
class ChatAdapter(var context: PageChatFragment, var items: ArrayList<Chat>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class MassageViewHolder(val  view: View) : RecyclerView.ViewHolder(view){
